# Adapted from: https://github.com/tensorflow/models/blob/master/object_detection/create_pet_tf_record.py
...
flags.DEFINE_string('label_map_path', 'tl_data/tl_label_map.pbtxt',
...
def main(_):
  ...
  logging.info('Reading from TL dataset.')
